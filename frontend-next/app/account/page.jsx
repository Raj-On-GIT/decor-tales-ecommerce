      ...
      <section className="rounded-2xl border border-[#d9e5e2] bg-[#f8fbfa] p-5">
        <div className="flex items-start justify-between gap-4">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full border border-[#E7E5E4] bg-white px-4 py-2 text-sm font-semibold text-[#1C1917] transition hover:border-[#D6D3D1] hover:text-black"
          >
            <KeyRound size={16} />
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              ...
              {security?.linked_identities?.map((identity) => (
                <span
                  ...
                  className="rounded-full bg-[#1C1917] px-3 py-1 text-xs font-semibold text-white"
                >
